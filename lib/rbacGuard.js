...
export const ROUTE_PERMISSIONS = [
  ...
  // 4. Designer Workspace & Design Studio (Admin, Manager, Designer)
  {
  ...
  // 6. WhatsApp Web Communication Hub (Admin, Manager, Sales, Designer)
  {
    prefix: '/dashboard/whatsapp',
    allowedRoles: [CANONICAL_ROLES.ADMIN, CANONICAL_ROLES.MANAGER, CANONICAL_ROLES.SALES, CANONICAL_ROLES.DESIGNER],
    label: 'WhatsApp Web Messaging Hub',
  },
